                ...
                <div class="content-margins">
                    <div class="row">
                        <div class="col-md-5 hidden-xs hidden-sm">
                            <div class="entry"><b>contact us:</b> <a href="tel:+21623650994">+216 23 650 994</a></div>
                            <div class="entry"><b>email:</b> <a href="contact@telephouni.tn">contact@telephouni.tn</a></div>
                        </div>
                        <div class="col-md-7 col-md-text-right">
                            ...
                            <div class="entry hidden-xs hidden-sm cart">
                                <a href="cart.html">
                                    ...
                                    <span class="cart-title hidden-xs">195.00TND</span>
                                </a>
                                            ...
                                            <div class="cart-entry-description">
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="simple-article size-3 grey">155.00TND</div>
                                                            <div class="simple-article size-1">TOTAL: 310.00TND</div>
                                                        </td>
                                                        <td>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-6">
                                            <div class="cell-view empty-space col-xs-b50">
                                                <div class="simple-article size-5 grey">TOTAL <span class="color">1195.00TND</span></div>
                                            </div>
                                        </div>
                                                        ...
                                                        <div class="col-xs-6">
                                                            <div class="product-shortcode style-5">
                                                                ...
                                                                <div class="content-animate">
                                                                    ...
                                                                    <div class="price">
                                                                        <div class="simple-article size-4 dark">630.00TND</div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="col-xs-6">
                                                            <div class="product-shortcode style-5">
                                                                ...
                                                                <div class="content-animate">
                                                                    ...
                                                                    <div class="price">
                                                                        <div class="simple-article size-4 dark">TND630.00</div>
                                                                    </div>
                                                                </div>
                                                                <div class="preview-buttons">
                                                                    <div class="buttons-wrapper">
                    ...
                    <div class="row nopadding">
                        ...
                        <div class="col-sm-4 col-lg-2">
                            <div class="product-shortcode style-7">
                                ...
                                <div class="price">
                                    <div class="simple-article size-2"><span class="color">24.00TND</span> <span class="line-through">32.00TND</span></div>
                                </div>
                                <div class="icons">
                                    <a class="entry"><i class="fa fa-check" aria-hidden="true"></i></a>
                                    <a class="entry open-popup" data-rel="3"><i class="fa fa-eye" aria-hidden="true"></i></a>
                        ...
                        <div class="col-sm-4 col-lg-2">
                            <div class="product-shortcode style-7">
                                ...
                                <div class="price">
                                    <div class="simple-article size-2"><span class="dark">24.00TND</span></div>
                                </div>
                                <div class="icons">
                                    <a class="entry"><i class="fa fa-check" aria-hidden="true"></i></a>
                                    <a class="entry open-popup" data-rel="3"><i class="fa fa-eye" aria-hidden="true"></i></a>
                ...
                <div class="footer-top">
                    <div class="row">
                        <div class="col-sm-6 col-md-3 col-xs-b30 col-md-b0">
                            ...
                            <div class="empty-space col-xs-b20"></div>
                            <div class="footer-contact"><i class="fa fa-mobile" aria-hidden="true"></i> contact us: <a href="tel:+21623650994">+216 23 650 994</a></div>
                            <div class="footer-contact"><i class="fa fa-envelope-o" aria-hidden="true"></i> email: <a href="mailto:contact@telephouni.tn">contact@telephouni.tn</a></div>
                ...
                <div class="footer-bottom">
                    <div class="row">
                        <div class="col-lg-8 col-xs-text-center col-lg-text-left col-xs-b20 col-lg-b0">
                            <div class="copyright">&copy; 2019 All rights reserved. Development by <a href="#" target="_blank">DevSpark Groupe</a></div>
                            <div class="follow">

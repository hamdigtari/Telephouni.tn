        ...
        <div class="popup-content" data-rel="1">
            ...
            <div class="popup-container size-1">
                <div class="popup-align">
                    ...
                    <input class="simple-input" type="text" value="" placeholder="Your username"   name="username"/>
            ...
            <div class="popup-container size-1">
                <div class="popup-align">
                  ...
                  <form action="<?php echo(URLROOT) ?>/process/p_register.php" method='POST'>
                    ...
                    <input class="simple-input" type="text" value="" placeholder="Your surname" name="surrname"/>
                    ...
                    <input class="simple-input" type="password" value="" placeholder="Enter password" name="password" name="password"  />

                    <div class="empty-space col-xs-b10 col-sm-b20"></div>

                    <input class="simple-input" type="password" value="" placeholder="Repeat password" name="confirm_password" />

        ...
        <div class="col-lg-4 col-md-12">
          <div class="card member-card">
            <div class="header l-blue">
              <h4 class="m-t-10"><?PHP echo ($row['name'] ); echo ($row['surname'] ); ?></h4>
            </div>
            <div class="member-img">
              <a href="" class="">
                <?php if(empty($row['image'])): ?>
                        <img src="img/manAVATAR2.jpg"  class="rounded-circle" alt="profile-image">
                        <?php else: ?>
                          <img src="<?= URLROOT.'/images/'.$row['image'] ?>"  class="rounded-circle" alt="profile-image">
                        <?php endif; ?>
            ...
            <div class="body">
              ...
              <div class="row">
                ...
                <div class="col-4">
                  <h5>membre since :</h5>
                  <small><?PHP echo (ClientsC::cTime($row['created_at'])); ?></small>
                </div>
                <div class="col-4">
                  <h5></h5>
                  <small></small>

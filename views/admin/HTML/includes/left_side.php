...
<aside id="leftsidebar" class="sidebar"> 
    ...
    <div class="user-info">
        <div class="image"> 
            <?php if(empty($user->image)): ?>
                        <img src="img/manAVATAR2.jpg"  width="48" height="48" alt="User">
                        <?php else: ?>
                          <img src="<?= URLROOT.'/images/'.$user->image ?>"  width="48" height="48" alt="User">
                        <?php endif; ?>
            

        </div>
        <div class="info-container">
            <div class="name" data-toggle="dropdown"><?php echo($user->name); echo($user->surname); ?></div>
            ...
            <div class="btn-group user-helper-dropdown"> <i class="material-icons" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" role="button"> keyboard_arrow_down </i>
                <ul class="dropdown-menu pull-right">
                    <li><a href="<?php echo(URLROOT); ?>/profile.php"><i class="material-icons">person</i>Profile</a></li>
    ...
    <div class="menu">
        <ul class="list">
            ...
            <li> <a href="javascript:void(0);" class="menu-toggle"><i class="material-icons">group</i><span>Clients</span></a>
                <ul class="ml-menu">
                    <li><a href="<?php echo(URLROOT); ?>/clients.php">All clients</a> </li>
                    <li><a href="<?php echo(URLROOT); ?>/edit_user.php">Update Client Profile</a></li>
                    <li><a href="<?php echo(URLROOT); ?>/add_user.php">Add Client</a></li>
                    <li><a href="<?php echo(URLROOT); ?>/delete_user.php">Delete Client</a></li>
                    <li><a href="ec-dashboard.html">Ecommerce Dashboard</a></li>
                </ul>
            </li>
            <li> <a href="javascript:void(0);" class="menu-toggle"><i class="material-icons">group</i><span>Admins</span></a>
                <ul class="ml-menu">
                    <li><a href="<?php echo(URLROOT); ?>/admins.php">All Admins</a> </li>
                    <li><a href="<?php echo(URLROOT); ?>/edit_admin.php">Update Admin Profile</a></li>
                    <li><a href="<?php echo(URLROOT); ?>/add_admin.php">Add Admin</a></li>
                    <li><a href="<?php echo(URLROOT); ?>/delete_admin.php">Delete Admin</a></li>

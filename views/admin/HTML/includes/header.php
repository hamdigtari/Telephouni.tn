                ...
                <div class="content-margins">
                    <div class="row">
                        <div class="col-md-5 hidden-xs hidden-sm">
                            <div class="entry"><b>contact us:</b> <a href="tel:+216 23 650 994">+216 23 650 994</a></div>
                            <div class="entry"><b>email:</b> <a href="mailto:contact@telephouni.tn">contact@telephouni.tn</a></div>
                        </div>
                        <div class="col-md-7 col-md-text-right">
                            <?php if (ClientsC::isUserLoggedIn()) { ?>

                        <div class="entry language">
                                <div class="title"><b><?php echo ($user->name);  ?></b></div>
...
<?php if(empty($user->image)): ?>
                                        <img src="img/manAVATAR.jpg" class="md-avatar rounded-circle" style=" width: 50px; height: 60px;border-radius: 50%!important;">
<?php else: ?>
                          <img src="<?= URLROOT.'/images/'.$user->image ?>" class="md-avatar rounded-circle" style=" width: 50px; height: 60px;border-radius: 50%!important;">
                        <?php endif; ?>

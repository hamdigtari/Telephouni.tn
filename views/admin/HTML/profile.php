        ...
        <div class="profile-header">
            <div class="profile_info row">
                ...
                <div class="col-lg-6 col-md-8 col-12">
                    <h4 class="m-t-5 m-b-0"><strong><?php echo($user->name); ?> </strong> <?php echo($user->surname); ?></h4>
                    <span class="job_post">@<?php echo($user->username); ?></span>
                    <p> member since : <?php echo(AdminC::cTime($user->created_at)); ?></p>
                    <div class="m-t-10">
                        <a  href="<?php echo(URLROOT); ?>/edit_profile.php" class="btn btn-raised btn-default"  >Edite Profile</a>
                            ...
                            <div role="tabpanel" class="tab-pane active" id="mypost">
                                ...
                                <div class="mypost-list m-t-30">
                                    <div class="post-box">
                                        ...
                                        <h4 class="post_title">It is a long established fact that a reader will be distracted</h4>
                                        <p>If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text</p>                                            
                                        <div class="form-group">
                                            <a href="javascript:void(0);" class="btn btn-raised btn-info"><i class="zmdi zmdi-favorite-outline"></i> Like (5) </a>
                                            <a href="javascript:void(0);" class="btn btn-raised btn-default"><i class="zmdi zmdi-long-arrow-return"></i> Reply</a>
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="post-box">
                                        ...
                                        <h4 class="post_title">There are many variations of passages of Lorem Ipsum available</h4>
                                    ...
                                    <div class="post-box">
                                        ...
                                        <h4 class="post_title">Contrary to popular belief, Lorem Ipsum is not simply random text</h4>

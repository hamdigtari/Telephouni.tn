...
<div class='alert alert-danger'>
    <strong>Danger!</strong>" .$_SESSION['msg_err']."
</div>";
        ...
        <div class="slider-wrapper">
            ...
            <div class="swiper-container page-height" data-direction="vertical" data-mousewheel="1">
                <div class="swiper-wrapper">
                                 ...
                                 <div class="col-sm-6 col-sm-offset-6 text-center">
                                     <div class="cell-view page-height">
                                         <div class="col-xs-b40 col-sm-b80"></div>
                                             ...
                                             <div class="simple-article grey size-5">BEST PRICE <span class="color">$175.00</span></div>
                             ...
                             <div class="slider-product-preview align-left">
                                 <div class="product-preview-shortcode">
                                     <div class="preview">
                                         ...
                                         <div class="entry full-size swiper-lazy active" data-background="img/product-preview-16.png"></div>
                                         <div class="entry full-size swiper-lazy" data-background="img/product-preview-17.png"></div>
                                     </div>
                                     <div class="sidebar valign-middle">
                                         <div class="valign-middle-content">
                                             <div class="entry active"><img src="img/product-93.png" alt="" /></div>
                                             <div class="entry"><img src="img/product-94.png" alt="" /></div>
                                         </div>
                                     </div>
                                 </div>
                             </div>
                    ...
                    <div class="swiper-slide" style="background: #343434;">
                         <div class="container">
                             <div class="row">
                                 <div class="col-sm-6 text-center">
                                     <div class="cell-view page-height">
                                         <div class="col-xs-b40 col-sm-b80"></div>
                                             <div class="simple-article size-3 uppercase light transparent">professional edition</div>
                                             <div class="col-xs-b5"></div>
                                             <h2 class="h2 light">black fenix nine</h2>
                                             <div class="col-xs-b15"></div>
                                             <div class="simple-article light transparent size-5">BEST PRICE <span class="color">$175.00</span></div>
                                             <div class="col-xs-b30"></div>
                                             <div class="buttons-wrapper">
                                                 <a class="button size-2 style-1" href="#">
                                                     <span class="button-wrapper">
                             ...
                             <div class="slider-product-preview align-right">
                                 <div class="product-preview-shortcode light-green">
                                     <div class="preview">
                                         <div class="swiper-lazy-preloader"></div>
                                         <div class="entry full-size swiper-lazy active" data-background="img/product-preview-17.png"></div>
                                         <div class="entry full-size swiper-lazy" data-background="img/product-preview-16.png"></div>
                                     </div>
                                     <div class="sidebar valign-middle">
                                         <div class="valign-middle-content">
                                             <div class="entry active"><img src="img/product-95.png" alt="" /></div>
                                             <div class="entry"><img src="img/product-96.png" alt="" /></div>
                                         </div>
                                     </div>
                                 </div>
                             </div>
                         ...
                         <div class="container">
                             ...
                             <div class="slider-product-preview align-left">
                                 <div class="product-preview-shortcode">
                                     <div class="preview">
                                         <div class="swiper-lazy-preloader"></div>
                                         <div class="entry full-size swiper-lazy active" data-background="img/product-preview-18.png"></div>
                                         <div class="entry full-size swiper-lazy" data-background="img/product-preview-19.png"></div>
                                         <div class="entry full-size swiper-lazy" data-background="img/product-preview-16.png"></div>
                                         <div class="entry full-size swiper-lazy" data-background="img/product-preview-17.png"></div>
                                     </div>
                                     <div class="sidebar valign-middle">
                                         <div class="valign-middle-content">
                                             <div class="entry active"><img src="img/product-97.png" alt="" /></div>
                                             <div class="entry"><img src="img/product-98.png" alt="" /></div>
                                             <div class="entry"><img src="img/product-99.png" alt="" /></div>
                                             <div class="entry"><img src="img/product-100.png" alt="" /></div>
                                         </div>
                                     </div>
                                 </div>
                             </div>
                         ...
                         <div class="container">
                                 ...
                                 <div class="col-sm-6 text-center">
                                     <div class="cell-view page-height">
                                         <div class="col-xs-b40 col-sm-b80"></div>
                                             <div class="simple-article size-3 uppercase light transparent">professional edition</div>
                                             <div class="col-xs-b5"></div>
                                             <h2 class="h2 light">blue silence</h2>
                                             <div class="col-xs-b15"></div>
                                             <div class="simple-article light transparent size-5">BEST PRICE <span class="color">$175.00</span></div>
                                             <div class="col-xs-b30"></div>
                                             <div class="buttons-wrapper">
                             ...
                             <div class="slider-product-preview align-right">
                                 <div class="product-preview-shortcode light-green">
                                     <div class="preview">
                                         <div class="swiper-lazy-preloader"></div>
                                         <div class="entry full-size swiper-lazy active" data-background="img/product-preview-19.png"></div>
                                         <div class="entry full-size swiper-lazy" data-background="img/product-preview-18.png"></div>
                                         <div class="entry full-size swiper-lazy" data-background="img/product-preview-16.png"></div>
                                         <div class="entry full-size swiper-lazy" data-background="img/product-preview-17.png"></div>
                                     </div>
                                     <div class="sidebar valign-middle">
                                         <div class="valign-middle-content">
                                             <div class="entry active"><img src="img/product-101.png" alt="" /></div>
                                             <div class="entry"><img src="img/product-102.png" alt="" /></div>
                                             <div class="entry"><img src="img/product-103.png" alt="" /></div>
                                             <div class="entry"><img src="img/product-104.png" alt="" /></div>
                                         </div>
                                     </div>
                                 </div>
                             </div>
                         ...
                         <div class="container">
                             ...
                             <div class="slider-product-preview align-left">
                                 <div class="product-preview-shortcode">
                                     <div class="preview">
                                         <div class="swiper-lazy-preloader"></div>
                                         <div class="entry full-size swiper-lazy active" data-background="img/product-preview-20.png"></div>
                                         <div class="entry full-size swiper-lazy" data-background="img/product-preview-17.png"></div>
                                         <div class="entry full-size swiper-lazy" data-background="img/product-preview-18.png"></div>
                                         <div class="entry full-size swiper-lazy" data-background="img/product-preview-19.png"></div>
                                     </div>
                                     <div class="sidebar valign-middle">
                                         <div class="valign-middle-content">
                                             <div class="entry active"><img src="img/product-105.png" alt="" /></div>
                                             <div class="entry"><img src="img/product-106.png" alt="" /></div>
                                             <div class="entry"><img src="img/product-107.png" alt="" /></div>
                                             <div class="entry"><img src="img/product-108.png" alt="" /></div>
                                         </div>
                                     </div>
                                 </div>
                             </div>
